...
namespace HumanInTheLoopDemo.Web.Components.Plugins
{
    public class LightsPlugin
    {
        ...
        {
            yield return AIFunctionFactory.Create(this.GetLightsAsync);
            yield return new ApprovalRequiredAIFunction(AIFunctionFactory.Create(this.ChangeStateAsync));
            yield return new ApprovalRequiredAIFunction(AIFunctionFactory.Create(this.ChangeColorAsync));
            yield return new ApprovalRequiredAIFunction(AIFunctionFactory.Create(this.ChangeBrightnessAsync));
        }
    }
