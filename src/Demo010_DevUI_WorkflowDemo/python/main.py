...
def main():
    ...
    print ("Setting up Azure OpenAI Chat Client...")
    print ("Using endpoint:", os.environ.get("AZURE_OPENAI_ENDPOINT"))
    print ("Using API version:", os.environ.get("AZURE_OPENAI_API_VERSION", "2025-01-01-preview"))
    print ("Using deployment name:", os.environ.get("AZURE_OPENAI_CHAT_DEPLOYMENT_NAME", "gpt-4o-demo"))
    ...
    chat_client = AzureOpenAIChatClient(
        ...
        deployment_name=os.environ.get("AZURE_OPENAI_CHAT_DEPLOYMENT_NAME", "gpt-4o-demo"),
